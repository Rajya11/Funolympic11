    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          <h3>New here ?</h3>
          <p>
            If you are new here you can register through Signup button.
          </p>
          ...
          <br>
          <br>
          <a href="http://localhost/login/admin.php" class="btn transparent" id="sign-in-btn" style="padding:10px 20px;text-decoration:none">
            Admin Login
          </a>
  </br>
        </div>
